        ...
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddCors(options =>
            {
                options.AddPolicy("AllowSpecificOrigin",
                    policyBuilder =>
                    {
                        policyBuilder.WithOrigins( "http://localhost:5173", "http://172.20.10.2:8081", "http://192.168.0.119:8081", "http://10.1.5.2:8081", "http://10.127.212.240:8081", "http://10.186.188.240:8081", "http://192.168.1.16:8081")
                                     .AllowAnyHeader()
                                     .AllowAnyMethod();
                    });
            });
